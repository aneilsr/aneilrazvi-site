...
{"file":"snhu.html","img":"snhu","title":"SNHU","category":"SNHU · Online Higher Education","role":"Director of Product Design · 2021–2023",
 ...
 "stats":[("0→1","Department built"),("7","Designers led"),("ML","Credit tool")],
 ...
 "did_h":"Team, craft, and systems, at once","did":["Built the Product Design department from zero: recruited the team, defined the function, and set the operating model","Led seven product designers directly within a broader org spanning graphic designers, researchers, and content creators, with a development partnership with Google","Materially boosted team productivity and satisfaction through career-ladder frameworks, mentorship, and design-operations maturity","Built multi-layered Figma design systems (architecture, motion, illustration) and the critique, design-review, and quality frameworks that held craft","Established a product-development lifecycle aligning design, product, and engineering","Led R&D for a next-generation skill-based learning platform through beta, plus an ML credit-for-prior-learning tool that halved a registrar's processing time"],
 "imp_h":"A function that scaled the craft","impact":["A mature design organization built from the ground up","Meaningful productivity gains and a stronger, better-supported team","Shipped learner-facing platforms and an ML tool that cut real processing time in half"],
